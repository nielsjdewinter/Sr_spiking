...
# Load data - Batch 1
Cedule_G003_1 <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Batch1/HR/Cedule_003_1.csv", header = TRUE)[-c(1, 2), ]
Cedule_G003_2 <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Batch1/HR/Cedule_003_2.csv", header = TRUE)
Cedule_G003_3 <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Batch1/HR/Cedule_003_3.csv", header = TRUE)
Cedule_G511_1 <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Batch1/HR/Cedule_511_1.csv", header = TRUE)
Cedule_G511_2 <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Batch1/HR/Cedule_511_2.csv", header = TRUE)
Cedule_G511_3 <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Batch1/HR/Cedule_511_3.csv", header = TRUE)
Cedule_G600_1 <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Batch1/HR/Cedule_600_1.csv", header = TRUE)
Cedule_G600_2 <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Batch1/HR/Cedule_600_1.csv", header = TRUE)
Cedule_G600_3 <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Batch1/HR/Cedule_600_3.csv", header = TRUE)
...
# Load from xlsx
filename <- "C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Batch2/LA data/01_20211025_SEQ326_NdW_LR__profiles.xlsx"
...
chalkypos <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Batch2/Oedulis_chalky_positions.csv", header = TRUE)
...
Scandist <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Extract scan positions/Scan_dist_conversion.csv")

# Load coordinates of scan lines
Batch1_pos <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Extract scan positions/Batch1_coordinates.csv")
...
Batch2_pos <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Extract scan positions/Batch2_coordinates.csv")
...
Refpts <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Extract scan positions/Refpoints.csv")
...
Spike_pos <- read.csv("C:/Users/Niels/Dropbox/Research/postdoc/UNBIAS/growth experiments/LAICPMS_Sr_spiking/Extract scan positions/Scan_spike_positions_mm.csv")
...
# ------------------------------------------------------------------------------
# Plot all data in peaks
allpeaks_Na <- ggplot(data = subset(LA_combined, peak == TRUE)) +
    geom_violin(aes(group = peakID,
            x = peakID,
            y = NaCa,
            fill = Species,
            color = Species),
    ...
    geom_errorbarh(data = Resultmat_clean,
        aes(xmin = Plot_X - 0.1,
            xmax = Plot_X + 0.1,
            y = Na_bkg * 1000 / 0.2,
            color = Species)) +
    scale_y_continuous("Na/Ca_peak\n[mmol/mol]",
        breaks = seq(0, 100, 10)) +
    scale_x_continuous("Specimen",
       breaks = unique(floor(LA_combined$peakID[!is.na(LA_combined$peakID)])),
       labels = unique(LA_combined$Specimen)) +
    coord_cartesian(ylim = c(0, 100)) +
    theme_bw()

allpeaks_Mg <- ggplot(data = subset(LA_combined, peak == TRUE)) +
    geom_violin(aes(group = peakID,
            x = peakID,
            y = MgCa,
            fill = Species,
...
allpeaks_Mn <- ggplot(data = subset(LA_combined, peak == TRUE)) +
    geom_violin(aes(group = peakID,
            x = peakID,
            y = MnCa,
            fill = Species,
...
allpeaks_Sr <- ggplot(data = subset(LA_combined, peak == TRUE)) +
    geom_violin(aes(group = peakID,
            x = peakID,
            y = SrCa,
            fill = Species,
...
allpeaks_Ba <- ggplot(data = subset(LA_combined, peak == TRUE)) +
    geom_violin(aes(group = peakID,
            x = peakID,
            y = BaCa,
            fill = Species,
...
allpeaks_combined <- ggarrange(allpeaks_Na + theme(axis.title.x = element_blank(),
        axis.text.x = element_blank()),
    allpeaks_Mg + theme(axis.title.x = element_blank(),
        axis.text.x = element_blank()),
    allpeaks_Mn + theme(axis.title.x = element_blank(),
        axis.text.x = element_blank()),
    allpeaks_Sr + theme(axis.title.x = element_blank(),
        axis.text.x = element_blank()),
    allpeaks_Ba + theme(axis.text.x = element_text(angle = 90)),
    ncol = 1,
    common.legend = TRUE,
    legend="right"
)