...
Dose_height_Na <- ggplot(data = Resultmat_clean) +
    geom_jitter(aes(x = Dose,
            y = Na_peak - Na_bkg,
            color = Species),
        width = 3E-5,
    ...
    geom_errorbar(data = Spike_peak_groups,
        aes(x = Dose,
            y = Na_relpeak_mean,
            ymin = Na_relpeak_mean - Na_relpeak_sd,
            ymax = Na_relpeak_mean + Na_relpeak_sd,
            color = Species),
        width = 5E-5,
        size = 1,
        position = pd) +
    ...
    scale_x_continuous("Dose of Sr spike in water [mmol/L]",
        breaks = seq(0, 0.0006, 0.0001),
        labels = seq(0, .6, 0.1)) +
    scale_y_continuous("Na/Ca peak relative to\nbackground [mmol/mol]",
        breaks = seq(-1E-3, 10E-3, 2E-3),
        labels = seq(-1, 10, 2)) +
    coord_cartesian(xlim = c(0, 0.0006),
        ylim = c(-1E-3, 10E-3)) +
    theme_bw()

Dose_height_Mg <- ggplot(data = Resultmat_clean) +
    geom_jitter(aes(x = Dose,
            y = Mg_peak - Mg_bkg,
            color = Species),
        width = 3E-5,
    ...
    geom_errorbar(data = Spike_peak_groups,
        aes(x = Dose,
            y = Mg_relpeak_mean,
            ymin = Mg_relpeak_mean - Mg_relpeak_sd,
            ymax = Mg_relpeak_mean + Mg_relpeak_sd,
            color = Species),
        width = 5E-5,
        size = 1,
        position = pd) +
    ...
    scale_x_continuous("Dose of Sr spike in water [mmol/L]",
        breaks = seq(0, 0.0006, 0.0001),
        labels = seq(0, .6, 0.1)) +
    scale_y_continuous("Mg/Ca peak relative to\nbackground [mmol/mol]",
        breaks = seq(-5E-3, 30E-3, 5E-3),
        labels = seq(-5, 30, 5)) +
    coord_cartesian(xlim = c(0, 0.0006),
        ylim = c(-5E-3, 30E-3)) +
    theme_bw()

Dose_height_Mn <- ggplot(data = Resultmat_clean) +
    geom_jitter(aes(x = Dose,
            y = Mn_peak - Mn_bkg,
            color = Species),
        width = 3E-5,
    ...
    geom_errorbar(data = Spike_peak_groups,
        aes(x = Dose,
            y = Mn_relpeak_mean,
            ymin = Mn_relpeak_mean - Mn_relpeak_sd,
            ymax = Mn_relpeak_mean + Mn_relpeak_sd,
            color = Species),
        width = 5E-5,
        size = 1,
        position = pd) +
    ...
    scale_x_continuous("Dose of Sr spike in water [mmol/L]",
        breaks = seq(0, 0.0006, 0.0001),
        labels = seq(0, .6, 0.1)) +
    scale_y_continuous("Mn/Ca peak relative to\nbackground [mmol/mol]",
        breaks = seq(-1E-4, 5E-4, 1E-4),
        labels = seq(-.1, .5, .1)) +
    coord_cartesian(xlim = c(0, 0.0006),
        ylim = c(-1E-4, 5E-4)) +
    theme_bw()

Dose_height_Ba <- ggplot(data = Resultmat_clean) +
    geom_jitter(aes(x = Dose,
            y = Ba_peak - Ba_bkg,
            color = Species),
        width = 3E-5,
    ...
    geom_errorbar(data = Spike_peak_groups,
        aes(x = Dose,
            y = Ba_relpeak_mean,
            ymin = Ba_relpeak_mean - Ba_relpeak_sd,
            ymax = Ba_relpeak_mean + Ba_relpeak_sd,
            color = Species),
        width = 5E-5,
        size = 1,
        position = pd) +
    ...
    scale_x_continuous("Dose of Sr spike in water [mmol/L]",
        breaks = seq(0, 0.0006, 0.0001),
        labels = seq(0, .6, 0.1)) +
    scale_y_continuous("Ba/Ca peak relative to\nbackground [umol/mol]",
        breaks = seq(-1E-6, 5E-6, 1E-6),
        labels = seq(-1, 5, 1)) +
    coord_cartesian(xlim = c(0, 0.0006),
        ylim = c(-1E-6, 5E-6)) +
    theme_bw()

Dose_combined_plot <- ggarrange(
    Dose_height_Na,
    Dose_height_Mg,
    Dose_height_Mn,
    Dose_height_Ba,
