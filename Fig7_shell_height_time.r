...
Shell_height_plot_G003 <- ggplot(data = subset(Resultmat_clean, subset = Specimen2 == "G003"),
        aes(x = Date,
            y = SL_mid)) +
...
Shell_height_plot_G511 <- ggplot(data = subset(Resultmat_clean, subset = Specimen2 == "G511"),
        aes(x = Date,
            y = SL_mid)) +
    geom_pointrange(aes(y = SL_peak,
            ymin = SL_start,
...
Shell_height_plot_G600 <- ggplot(data = subset(Resultmat_clean, subset = Specimen2 == "G600"),
        aes(x = Date,
            y = SL_mid)) +
    geom_pointrange(aes(y = SL_peak,
            ymin = SL_start,
...
Shell_height_plot_G457 <- ggplot(data = subset(Resultmat_clean, subset = Specimen2 == "G457"),
        aes(x = Date,
            y = SL_mid)) +
    geom_pointrange(aes(y = SL_peak,
            ymin = SL_start,
...
Shell_height_plot_G472 <- ggplot(data = subset(Resultmat_clean, subset = Specimen2 == "G472"),
        aes(x = Date,
            y = SL_mid)) +
    geom_pointrange(aes(y = SL_peak,
            ymin = SL_start,
...
Shell_height_plot_G555 <- ggplot(data = subset(Resultmat_clean, subset = Specimen2 == "G555"),
        aes(x = Date,
            y = SL_mid)) +
    geom_pointrange(aes(y = SL_peak,
            ymin = SL_start,
...
Shell_height_plot_G177 <- ggplot(data = subset(Resultmat_clean, subset = Specimen2 == "G177"),
        aes(x = Date,
            y = SL_mid)) +
    geom_pointrange(aes(y = SL_peak,
            ymin = SL_start,
...
Shell_height_plot_G191 <- ggplot(data = subset(Resultmat_clean, subset = Specimen2 == "G191"),
        aes(x = Date,
            y = SL_mid)) +
    geom_pointrange(aes(y = SL_peak,
            ymin = SL_start,
...
Shell_height_plot_G259 <- ggplot(data = subset(Resultmat_clean, subset = Specimen2 == "G259"),
        aes(x = Date,
            y = SL_mid)) +
    geom_pointrange(aes(y = SL_peak,
            ymin = SL_start,
...
Shell_height_plot_G271 <- ggplot(data = subset(Resultmat_clean, subset = Specimen2 == "G271"),
        aes(x = Date,
            y = SL_mid)) +
    geom_pointrange(aes(y = SL_peak,
            ymin = SL_start,
...
Shell_height_plot_G282 <- ggplot(data = subset(Resultmat_clean, subset = Specimen2 == "G282"),
        aes(x = Date,
            y = SL_mid)) +
    geom_pointrange(aes(y = SL_peak,
            ymin = SL_start,
...
Shell_height_plot_G372 <- ggplot(data = subset(Resultmat_clean, subset = Specimen2 == "G372"),
        aes(x = Date,
            y = SL_mid)) +
    geom_pointrange(aes(y = SL_peak,
            ymin = SL_start,
...
Combined_shell_height_plots <- ggarrange(
    # C. edule
    Shell_height_plot_G003,
    Shell_height_plot_G511,
    Shell_height_plot_G600,
    Shell_height_plot_G457,
    Shell_height_plot_G472,
    Shell_height_plot_G555,
    # M. edulis
    Shell_height_plot_G177,
    Shell_height_plot_G191,
    Shell_height_plot_G259,
    # O. edulis
    Shell_height_plot_G271,
    Shell_height_plot_G282,
    Shell_height_plot_G372,
    ncol = 6,
    nrow = 2,
    common.legend = TRUE
)